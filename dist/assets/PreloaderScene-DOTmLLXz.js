...
`;function he(){const t=m.useRef(null),r=m.useMemo(()=>new y({vertexShader:j,fragmentShader:J,transparent:!0,depthWrite:!1,blending:A,uniforms:{uTime:{value:0},uPulse:{value:0},uAlpha:{value:0}}}),[]);return b(u=>{const a=t.current;if(!a)return;const e=w.t,n=h(.04,.5,e)*(1-h(o.bang-.02,o.bang+.05,e));if(r.uniforms.uAlpha.value=n,r.uniforms.uTime.value=e,r.uniforms.uPulse.value=h(.55,o.bang,e),a.visible=n>.004,!a.visible)return;a.quaternion.copy(u.camera.quaternion);const s=h(o.collapse,o.bang,e),c=h(.8,o.bang,e);a.scale.setScalar(O.lerp(2.4,.9,s*s)),a.position.set((Math.random()-.5)*.05*c,(Math.random()-.5)*.05*c,0)}),i.jsx("mesh",{ref:t,material:r,renderOrder:20,frustumCulled:!1,visible:!1,children:i.jsx("planeGeometry",{args:[1,1]})})}function me({count:t}){const r=m.useRef(null),u=m.useMemo(()=>{const e=new k,n=new Float32Array(t*3),s=new Float32Array(t),c=new Float32Array(t);for(let f=0;f<t;f++){const l=Math.random()*2-1,v=Math.random()*Math.PI*2,p=Math.sqrt(1-l*l);n[f*3]=p*Math.cos(v),n[f*3+1]=p*Math.sin(v),n[f*3+2]=l,s[f]=.18+Math.pow(Math.random(),.6)*1.32,c[f]=Math.random()}return e.setAttribute("position",new d(new Float32Array(t*3),3)),e.setAttribute("aDir",new d(n,3)),e.setAttribute("aSpeed",new d(s,1)),e.setAttribute("aPhase",new d(c,1)),e.boundingSphere=new D(new S,1e4),e},[t]),a=m.useMemo(()=>new y({vertexShader:ee,fragmentShader:ae,transparent:!0,depthWrite:!1,blending:A,uniforms:{uT:{value:-1},uPixelRatio:{value:1},uFade:{value:1}}}),[]);return b(e=>{const n=r.current;if(!n)return;const s=w.t;a.uniforms.uT.value=s-o.bang,a.uniforms.uPixelRatio.value=e.viewport.dpr,a.uniforms.uFade.value=1-h(o.universe+.4,o.hole-.4,s),n.visible=s>o.bang-.05&&a.uniforms.uFade.value>.01}),i.jsx("points",{ref:r,geometry:u,material:a,frustumCulled:!1,visible:!1})}const ve=[{at:0,rate:.36,width:.05,peak:1},{at:.3,rate:.25,width:.09,peak:.6},{at:.8,rate:.16,width:.15,peak:.32}];function de(){const t=m.useRef(null),r=m.useMemo(()=>ve.map(u=>[u,new y({vertexShader:j,fragmentShader:te,transparent:!0,depthWrite:!1,blending:A,uniforms:{uRadius:{value:0},uWidth:{value:u.width},uAlpha:{value:0}}})]),[]);return b(u=>{const a=t.current;if(!a)return;const e=w.t-o.bang;a.visible=e>-.05&&e<6,a.visible&&(a.quaternion.copy(u.camera.quaternion),r.forEach(([n,s],c)=>{const f=e-n.at,l=a.children[c];if(f<=0){l.visible=!1;return}l.visible=!0;const v=(1-Math.exp(-n.rate*f))*1.35;s.uniforms.uRadius.value=v,s.uniforms.uAlpha.value=n.peak*Math.exp(-f*.5)}))}),i.jsx("group",{ref:t,renderOrder:18,visible:!1,children:r.map(([,u],a)=>i.jsx("mesh",{material:u,frustumCulled:!1,children:i.jsx("planeGeometry",{args:[46,46]})},a))})}const B=[[1,.96,.9],[.82,.88,1],[1,.86,.72],[.92,.94,1]];function pe({count:t}){const r=m.useRef(null),u=m.useMemo(()=>{const e=new k,n=new Float32Array(t*3),s=new Float32Array(t),c=new Float32Array(t),f=new Float32Array(t*3);for(let l=0;l<t;l++){const v=Math.random()*2-1,p=Math.random()*Math.PI*2,M=Math.sqrt(1-v*v),R=22+Math.pow(Math.random(),.6)*60;n[l*3]=M*Math.cos(p)*R,n[l*3+1]=M*Math.sin(p)*R*.75,n[l*3+2]=v*R-12,s[l]=.7+Math.pow(Math.random(),2.4)*2.6,c[l]=Math.random();const g=B[Math.random()*B.length|0];f[l*3]=g[0],f[l*3+1]=g[1],f[l*3+2]=g[2]}return e.setAttribute("position",new d(n,3)),e.setAttribute("aSize",new d(s,1)),e.setAttribute("aPhase",new d(c,1)),e.setAttribute("aColor",new d(f,3)),e},[t]),a=m.useMemo(()=>new y({vertexShader:N,fragmentShader:G,transparent:!0,depthWrite:!1,blending:A,uniforms:{uTime:{value:0},uPixelRatio:{value:1},uReveal:{value:0},uStretch:{value:0}}}),[]);return b(e=>{const n=r.current;if(!n)return;const s=w.t;a.uniforms.uTime.value=s,a.uniforms.uPixelRatio.value=e.viewport.dpr,a.uniforms.uReveal.value=h(o.universe-.3,o.universe+1.5,s),a.uniforms.uStretch.value=h(o.wormhole,o.flash,s),n.visible=a.uniforms.uReveal.value>.01}),i.jsx("points",{ref:r,geometry:u,material:a,frustumCulled:!1,visible:!1})}const H=[{pos:[-16,5,-26],scale:44,a:"#2e0a12",b:"#8B0000",seed:1.7,alpha:.5},{pos:[18,-7,-34],scale:54,a:"#121830",b:"#3d5a92",seed:5.2,alpha:.44},{pos:[2,10,-46],scale:62,a:"#241028",b:"#5a3570",seed:9.4,alpha:.34},{pos:[-28,-10,-52],scale:58,a:"#301016",b:"#a03040",seed:3.3,alpha:.3},{pos:[30,9,-64],scale:66,a:"#0e1c2a",b:"#2e6f8a",seed:7.1,alpha:.28},{pos:[-6,-15,-40],scale:48,a:"#1c0f2e",b:"#7a4ea0",seed:11.8,alpha:.3}];function ge({lite:t}){const r=t?H.slice(0,3):H,u=m.useRef(null),a=m.useMemo(()=>r.map(e=>new y({vertexShader:j,fragmentShader:oe,transparent:!0,depthWrite:!1,blending:A,uniforms:{uTime:{value:0},uAlpha:{value:0},uSeed:{value:e.seed},uColorA:{value:new P(e.a)},uColorB:{value:new P(e.b)}}})),[r]);return b(e=>{const n=u.current;if(!n)return;const s=w.t,c=h(o.bang+.35,o.universe+1.2,s),f=1-h(o.wormhole,o.flash,s);n.visible=c>.01&&f>.01,n.visible&&(a.forEach((l,v)=>{l.uniforms.uTime.value=s,l.uniforms.uAlpha.value=r[v].alpha*c*f}),n.children.forEach(l=>l.quaternion.copy(e.camera.quaternion)))}),i.jsx("group",{ref:u,visible:!1,children:r.map((e,n)=>i.jsx("mesh",{position:e.pos,material:a[n],renderOrder:2,frustumCulled:!1,children:i.jsx("planeGeometry",{args:[e.scale,e.scale]})},n))})}const be=[{pos:[-19,7,-44],rot:[.5,.2,.35],scale:1,spin:.11,arms:3,count:7e3,core:"#ffe6c2",edge:"#6f86c9",delay:0},{pos:[24,-6,-58],rot:[-.7,.4,-.2],scale:.62,spin:-.16,arms:2,count:3200,core:"#ffd9d0",edge:"#b06a8a",delay:.5},{pos:[7,15,-70],rot:[1.1,-.3,.5],scale:.8,spin:.08,arms:4,count:3200,core:"#fff2da",edge:"#5a7ec9",delay:.9}];function we({spec:t,lite:r}){const u=m.useRef(null),a=m.useRef(null),e=r?Math.floor(t.count*.4):t.count,n=m.useMemo(()=>{const c=new k,f=new Float32Array(e*3),l=new Float32Array(e),v=new Float32Array(e),p=new Float32Array(e*3),M=new P(t.core),R=new P(t.edge);for(let g=0;g<e;g++){const F=Math.pow(Math.random(),.62)*11,V=g%t.arms*(Math.PI*2/t.arms)+F*.44+(Math.random()-.5)*.5,C=(1-F/11)*.5+.22;f[g*3]=Math.cos(V)*F+(Math.random()-.5)*C*2.4,f[g*3+1]=(Math.random()-.5)*C*(1.6-F*.09),f[g*3+2]=Math.sin(V)*F+(Math.random()-.5)*C*2.4,l[g]=.5+Math.random()*1.5,v[g]=Math.random();const z=M.clone().lerp(R,Math.min(1,F/9));p[g*3]=z.r,p[g*3+1]=z.g,p[g*3+2]=z.b}return c.setAttribute("position",new d(f,3)),c.setAttribute("aSize",new d(l,1)),c.setAttribute("aPhase",new d(v,1)),c.setAttribute("aColor",new d(p,3)),c},[e,t]),s=m.useMemo(()=>new y({vertexShader:N,fragmentShader:G,transparent:!0,depthWrite:!1,blending:A,uniforms:{uTime:{value:0},uPixelRatio:{value:1},uReveal:{value:0},uStretch:{value:0}}}),[]);return b((c,f)=>{const l=u.current;if(!l||!a.current)return;const v=w.t;s.uniforms.uTime.value=v,s.uniforms.uPixelRatio.value=c.viewport.dpr;const p=h(o.universe+t.delay,o.universe+t.delay+1.5,v);s.uniforms.uReveal.value=p;const M=1-h(o.hole+.4,o.wormhole,v);l.visible=p>.01&&M>.01,l.visible&&(s.uniforms.uStretch.value=0,a.current.rotation.y+=f*t.spin,l.scale.setScalar(t.scale*M))}),i.jsx("group",{ref:u,position:t.pos,rotation:t.rot,visible:!1,children:i.jsx("points",{ref:a,geometry:n,material:s,frustumCulled:!1})})}function xe({lite:t}){return i.jsx(i.Fragment,{children:be.map((r,u)=>i.jsx(we,{spec:r,lite:t},u))})}function ye(){const t=m.useRef(null),r=m.useRef(null),u=m.useMemo(()=>new y({vertexShader:re,fragmentShader:ne,transparent:!0,depthWrite:!1,blending:A,side:K,uniforms:{uColor:{value:new P("#7fa6ff")}}}),[]),a=m.useMemo(()=>new S(9,-3.4,-40),[]),e=m.useMemo(()=>new S(-5.5,2.2,12),[]);return b((n,s)=>{const c=t.current;if(!c)return;const f=w.t,l=h(o.universe+.25,o.hole-.05,f);c.visible=l>.001&&l<.999,c.visible&&(c.position.set(x(a.x,e.x,l),x(a.y,e.y,l),x(a.z,e.z,l)),r.current&&(r.current.rotation.y+=s*.16))}),i.jsxs("group",{ref:t,visible:!1,children:[i.jsxs("mesh",{ref:r,children:[i.jsx("sphereGeometry",{args:[2.4,48,48]}),i.jsx("meshStandardMaterial",{color:"#2f3644",roughness:.85,metalness:.05})]}),i.jsx("mesh",{scale:1.12,material:u,children:i.jsx("sphereGeometry",{args:[2.4,32,32]})})]})}const I=new S(0,0,T),U=new S;function Me({lite:t}){const r=m.useRef(null),u=m.useMemo(()=>new y({vertexShader:se,fragmentShader:ie(t?60:110),transparent:!0,depthWrite:!1,uniforms:{uTime:{value:0},uCenter:{value:I.clone()},uCamPos:{value:new S},uFade:{value:0}}}),[t]);return b(a=>{const e=r.current;if(!e)return;const n=w.t,s=h(o.hole-.9,o.hole+.6,n)*(1-h(o.wormhole+.25,o.flash,n));u.uniforms.uFade.value=s,e.visible=s>.01,e.visible&&(u.uniforms.uTime.value=n,u.uniforms.uCamPos.value.copy(a.camera.position),e.quaternion.copy(a.camera.quaternion))}),i.jsx("mesh",{ref:r,position:I,material:u,renderOrder:8,frustumCulled:!1,visible:!1,children:i.jsx("planeGeometry",{args:[80,80]})})}function Ae({count:t}){const r=m.useRef(null),u=m.useMemo(()=>{const e=new k,n=new Float32Array(t),s=new Float32Array(t),c=new Float32Array(t),f=new Float32Array(t);for(let l=0;l<t;l++)n[l]=8+Math.pow(Math.random(),.7)*16,s[l]=Math.random()*Math.PI*2,c[l]=(Math.random()-.5)*5,f[l]=.6+Math.random()*1.4;return e.setAttribute("position",new d(new Float32Array(t*3),3)),e.setAttribute("aR0",new d(n,1)),e.setAttribute("aAng",new d(s,1)),e.setAttribute("aTilt",new d(c,1)),e.setAttribute("aRate",new d(f,1)),e.boundingSphere=new D(new S,1e4),e},[t]),a=m.useMemo(()=>new y({vertexShader:le,fragmentShader:ue,transparent:!0,depthWrite:!1,blending:A,uniforms:{uT:{value:-1},uPixelRatio:{value:1},uFade:{value:0}}}),[]);return b(e=>{const n=r.current;if(!n)return;const s=w.t;a.uniforms.uT.value=s-(o.hole-1),a.uniforms.uPixelRatio.value=e.viewport.dpr;const c=h(o.hole-.3,o.hole+.8,s)*(1-h(o.wormhole+.2,o.flash,s));a.uniforms.uFade.value=c,n.visible=c>.01}),i.jsx("points",{ref:r,position:I,rotation:[-.32,0,0],geometry:u,material:a,renderOrder:7,frustumCulled:!1,visible:!1})}function Se(){const t=m.useRef(null),r=m.useMemo(()=>new y({vertexShader:j,fragmentShader:ce,transparent:!0,depthWrite:!1,side:K,blending:A,uniforms:{uTime:{value:0},uAlpha:{value:0},uRush:{value:0},uAccent:{value:new P("#8B0000")}}}),[]);return b(()=>{const u=t.current;if(!u)return;const a=w.t,e=h(o.wormhole-.2,o.wormhole+.35,a)*(1-h(o.flash,o.flash+.25,a));if(r.uniforms.uAlpha.value=e,u.visible=e>.01,!u.visible)return;r.uniforms.uTime.value=a;const n=h(o.wormhole,o.flash,a);r.uniforms.uRush.value=n,u.scale.set(1+n*.5,1,1+n*.5)}),i.jsx("mesh",{ref:t,position:[0,0,T+16],rotation:[Math.PI/2,0,0],material:r,renderOrder:9,frustumCulled:!1,visible:!1,children:i.jsx("cylinderGeometry",{args:[7,7,64,64,1,!0]})})}function Fe(){const t=m.useRef(null),r=m.useMemo(()=>new y({vertexShader:j,fragmentShader:fe,transparent:!0,depthTest:!1,depthWrite:!1,uniforms:{uFlash:{value:0}}}),[]);return b(u=>{const a=t.current;if(!a)return;const e=w.t,n=h(o.flash-.14,o.flash,e),s=1-h(o.flash+.05,o.flash+1.1,e),c=n*s;if(r.uniforms.uFlash.value=c,a.visible=c>.002,!a.visible)return;const f=u.camera,l=.4;U.set(0,0,-1).applyQuaternion(f.quaternion),a.position.copy(f.position).addScaledVector(U,l),a.quaternion.copy(f.quaternion);const v=2*l*Math.tan(O.degToRad(f.fov*.5));a.scale.set(v*(u.size.width/u.size.height)*1.05,v*1.05,1)}),i.jsx("mesh",{ref:t,material:r,renderOrder:999,frustumCulled:!1,visible:!1,children:i.jsx("planeGeometry",{args:[1,1]})})}const W=new S;function _(t,r){return Math.sin(t*37.1+r)*.55+Math.sin(t*61.7+r*2.3)*.3+Math.sin(t*13.3+r*5.1)*.15}function Pe({quiet:t}){return b(r=>{const u=r.camera,a=w.t;let e=6;e=x(e,5.35,h(o.collapse-.2,o.bang,a)),e=x(e,14.5,h(o.bang,o.universe-.3,a)),e=x(e,.5,h(o.universe,o.hole,a)),e=x(e,-15,h(o.hole,o.wormhole,a));const n=h(o.wormhole,o.flash,a);e=x(e,T+2.5,n*n*n);let s=45;s=x(s,52,h(o.universe,o.hole,a)),s=x(s,60,h(o.hole,o.wormhole,a)),s=x(s,96,n*n);const c=t?0:Math.exp(-Math.max(0,a-o.bang)*1.3)*h(o.bang-.02,o.bang+.1,a),f=t?0:n*.25,l=_(a,1.7)*(.3*c+.06*f),v=_(a,4.9)*(.24*c+.05*f),p=t?0:Math.sin(a*.31)*.5*h(o.universe,o.hole,a),M=t?0:Math.cos(a*.24)*.34*h(o.universe,o.hole,a);u.position.set(l+p,v+M,e),W.set(p*.3,M*.3,a<o.universe?0:T),u.lookAt(W),u.rotation.z+=t?0:n*n*1.5+_(a,9.1)*.02*c,Math.abs(u.fov-s)>.01&&(u.fov=s,u.updateProjectionMatrix())}),null}function Re(){const t=m.useMemo(()=>new Z,[]);return b(()=>{const r=h(o.wormhole,o.flash,w.t);t.set(r*.0024,r*.0017)}),i.jsx(Q,{blendFunction:Y.NORMAL,offset:t,radialModulation:!1,modulationOffset:0})}function Ue({quiet:t,lite:r}){return i.jsxs(E,{dpr:r?[1,1.5]:[1,2],gl:{antialias:!1,powerPreference:"high-performance",alpha:!1},camera:{position:[0,0,6],fov:45,near:.1,far:400},style:{background:"#000000"},children:[i.jsx("color",{attach:"background",args:["#000000"]}),i.jsx("ambientLight",{intensity:.12}),i.jsx("directionalLight",{position:[14,10,6],intensity:1.4,color:"#fff4e6"}),i.jsx(Pe,{quiet:t}),i.jsx(he,{}),i.jsx(me,{count:r?3e4:12e4}),i.jsx(de,{}),i.jsx(ge,{lite:r}),i.jsx(pe,{count:r?3e3:9e3}),i.jsx(xe,{lite:r}),i.jsx(ye,{}),i.jsx(Ae,{count:r?900:2600}),i.jsx(Me,{lite:r}),i.jsx(Se,{}),i.jsx(Fe,{}),!r&&i.jsxs(L,{multisampling:0,children:[i.jsx($,{intensity:1.15,luminanceThreshold:.4,luminanceSmoothing:.85,mipmapBlur:!0}),i.jsx(Re,{}),i.jsx(X,{eskil:!1,offset:.2,darkness:.85})]})]})}export{Ue as default};
